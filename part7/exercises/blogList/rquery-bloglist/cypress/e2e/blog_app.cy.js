		...
		describe("When logged in", function () {
			...
			describe("When there are some blogs", function () {
				beforeEach(function () {
					...
					cy.createBlog({
						title: "Test blog 2 to be deleted",
						author: "Cypress CLI - delete",
						url: "delete.com",
					})
					cy.createBlog({
						title: "Test blog 3",
					...
					cy.createBlog({
						title: "Test blog 4 from another user",
						author: "Cypress CLI2",
						url: "anotheruser.com",
					})
					cy.contains("logout").click()
				...
				it("A blog can be deleted by the creator user", function () {
					cy.contains("Test blog 2 to be deleted")
						.find("button")
						.click()
					cy.contains("Test blog 2 to be deleted")
						.parent()
				...
				it("A blog can not be deleted by another user", function () {
					...
					cy.get(".notification")
						.should(
							"contain",
							"user do not have permission to delete this blog",
						)
						.and("have.css", "color", "rgb(255, 0, 0)")
						.and("have.css", "border-style", "solid")
				...
				it("blogs are ordered by amount of likes", function () {
					...
					cy.get(".blogs")
						...
						.should(
							"contain",
							"Title: Test blog 4 from another user - by Cypress CLI2",
						)
						.and("contain", "Likes: 4")
					...
					cy.get(".blogs")
						.eq(2)
						.should("contain", "Test blog 2 to be deleted")
						.and("contain", "Likes: 2")
